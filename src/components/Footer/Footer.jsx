        ...
        <div className='w-[85%] h-[650px] mx-auto mt-[80px] bg-[#f7f7f7] border-b-[3px] border-green-100'>
                ...
                {footerData.map((item, index) => (
                    <div key={index} className='w-[22%] h-[100%]  flex items-center justify-center'>
                        <div className='w-[85%] h-[85%] relative border-r-[2px]'>
                            ...
                            <p className='text-[#636262] mt-[5px]'>{item.common_info}</p>
                        </div>
                    </div>
                ))
            ...
            <div className='w-[100%] h-[15%] bg-[rgba(227,253,229,0.4)]'>
                <ul className='w-[75%] h-[100%] flex items-center justify-between ml-[20px]'>
                    ...
                    <li className='flex items-center gap-2'><FmdGoodIcon className='text-green-500' /><p className='w-[210px] text-[#343333]'>70 West Buckingham Ave.Farmingdale, NY 11735</p></li>
                    <li className='flex items-center gap-2'><img src={message} alt="" className='w-[25px] h-[25px]' /><p className='font-normal text-[#343333]'>contact@greenshop.com</p></li>
                    <li className='flex gap-2'><PhoneIcon className='text-green-500' /><p className='font-normal text-[#343333]'>+88 01911 717 490</p></li>
                </ul>
            </div>
                ...
                <div className='w-[95%] h-[90%] flex justify-between items-center mx-auto'>
                    ...
                    <div className='w-[34%] h-[100%]'>
                        ...
                        <ul className='flex items-center gap-3 mt-[10px]'>
                            <li><img src={paypay} alt="" className='w-[70px]'/></li>
                            <li><img src={mastercard} alt="" className='w-[40px]'/></li>
                            <li><img src={visa} alt=""  className='w-[60px]'/></li>
                            <li><img src={americanExpress} alt="" className='w-[60px]'/></li>
                        </ul>
                    </div>
                </div>
            </div>
